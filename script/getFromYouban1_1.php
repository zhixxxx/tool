...
define("DATA_NEWID_FILE",'youban_9.txt');//youban_7.txt
$cate = '安徒生童话';//'幼儿故事';//'动画故事';//'神话故事';//'名人故事';//'寓言故事';//'成语故事';//test; 

$arrUrl[] = array('新年','http://www.youban.com/story-t2298.html');
$arrUrl[] = array('圣诞','http://www.youban.com/story-t2206.html');
$arrUrl[] = array('温暖','http://www.youban.com/story-t2221.html');

$arrUrl[] = array('经典故事','http://www.youban.com/story-t1162.html');
$arrUrl[] = array('宝宝故事','http://www.youban.com/story-t1703.html');
$arrUrl[] = array('睡前篇','http://www.youban.com/story-t1627.html');
$arrUrl[] = array('妈妈讲故事','http://www.youban.com/story-t1628.html');
$arrUrl[] = array('睡前篇','http://www.youban.com/story-t1099.html');
$arrUrl[] = array('益智篇','http://www.youban.com/story-t800.html');
$arrUrl[] = array('情商篇','http://www.youban.com/story-t1068.html');
$arrUrl[] = array('性格篇','http://www.youban.com/story-t1183.html');
$arrUrl[] = array('美德篇','http://www.youban.com/story-t808.html');
$arrUrl[] = array('自信篇','http://www.youban.com/story-t806.html');
$arrUrl[] = array('胎教篇','http://www.youban.com/story-t2311.html');


foreach($arrUrl as $url){
$arrA = getListWWW($url[1]);
$cate = $url[0];
$tempArr = array();
...
function getUrlContent($url,$creat=false){
    ...
    if(!$content || $creat == true){
        echo "need get\n";
        #sleep(1);
        $content = Http::getInstance()->Snoopy_get_contents($url);
        if($content != ''){
