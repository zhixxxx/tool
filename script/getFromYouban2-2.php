...
define("GUOLVLINK","51cto\.com\/|360baidu");
include "../libs/Http.class.php";

$url = 'http://www.youban.com/book/pdcate.php?type=1&classid=12&push=1&page=1';
$cate = '成语故事'; 



$tempArr = json_decode(file_get_contents(DATA_NEWID.'youban.txt'),true);
...
$str = implode("\r\n",$arr2);
file_put_contents(DATA_NEWID.'youban_new.txt',$str);
exit;
