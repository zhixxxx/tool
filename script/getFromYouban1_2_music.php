...
define("DATA_NEWID_FILE",'youban_17.txt');//youban_12.txt
$cate = '儿歌串烧50首';//'成语故事';//'睡前故事';//'格林童话';//'安徒生童话';//'幼儿故事';//'动画故事';//'神话故事';//'名人故事';//'寓言故事';//'成语故事';//test; 
$arrUrl[] = 'http://www.youban.com/mp3-t3210.html';
