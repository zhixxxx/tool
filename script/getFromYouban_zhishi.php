...
define("DATA_NEWID",DATA_DIR.'/zhishi/');

define("DATA_NEWID_FILE",'youban_1.txt');//youban_7.txt
$cate = '儿歌大全';//'幼儿故事';//'动画故事';//'神话故事';//'名人故事';//'寓言故事';//'成语故事';//test; 

$arrUrl[] = 'http://www.youban.com/book/pdbook.php?type=8&push=1&page=1';
$arrUrl[] = 'http://www.youban.com/book/pdbook.php?type=8&push=1&page=2';
$arrUrl[] = 'http://www.youban.com/book/pdbook.php?type=8&push=1&page=3';
$arrUrl[] = 'http://www.youban.com/book/pdbook.php?type=8&push=1&page=4';
$arrUrl[] = 'http://www.youban.com/book/pdbook.php?type=8&push=1&page=5';
$arrUrl[] = 'http://www.youban.com/book/pdbook.php?type=8&push=1&page=6';
$arrUrl[] = 'http://www.youban.com/book/pdbook.php?type=8&push=1&page=7';
$arrUrl[] = 'http://www.youban.com/book/pdbook.php?type=8&push=1&page=8';
$arrUrl[] = 'http://www.youban.com/book/pdbook.php?type=8&push=1&page=9';
$arrUrl[] = 'http://www.youban.com/book/pdbook.php?type=8&push=1&page=10';
$arrUrl[] = 'http://www.youban.com/book/pdbook.php?type=8&push=1&page=11';
$arrUrl[] = 'http://www.youban.com/book/pdbook.php?type=8&push=1&page=12';
$arrUrl[] = 'http://www.youban.com/book/pdbook.php?type=8&push=1&page=13';
$arrUrl[] = 'http://www.youban.com/book/pdbook.php?type=8&push=1&page=14';
$arrUrl[] = 'http://www.youban.com/book/pdbook.php?type=8&push=1&page=15';
/*
...
function saveArr($data){
	...
	$newarr = array();
$tempArr = file(DATA_NEWID.DATA_NEWID_FILE);
foreach($tempArr as $key=>$val){
	$val = str_replace(array("\n","\r"),"",$val);
	$arr = explode("`",$val);
	foreach($arr as $v){
