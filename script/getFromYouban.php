...
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=14&push=1&page=1';
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=14&push=1&page=2';
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=14&push=1&page=3';
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=14&push=1&page=4';
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=14&push=1&page=5';
/*
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=701&push=1&page=1';
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=701&push=1&page=2';
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=701&push=1&page=3';
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=701&push=1&page=4';
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=701&push=1&page=5';
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=701&push=1&page=6';
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=701&push=1&page=7';
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=701&push=1&page=8';
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=701&push=1&page=9';
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=701&push=1&page=10';
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=701&push=1&page=11';
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=701&push=1&page=12';

/*
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=11&push=1&page=1';
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=11&push=1&page=2';

$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=12&push=1&page=1';
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=12&push=1&page=2';
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=12&push=1&page=3';
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=12&push=1&page=4';
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=12&push=1&page=5';
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=12&push=1&page=6';

$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=42&push=1&page=1';
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=42&push=1&page=2';
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=42&push=1&page=3';
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=42&push=1&page=4';

$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=13&push=1&page=1';
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=13&push=1&page=2';
$arrUrl[] = 'http://www.youban.com/book/pdcate.php?type=1&classid=13&push=1&page=3';
...
foreach($arrA[1] as $key=>$val){
	$url2 = $val;
	$title = $arrA[2][$key];
	$img2 = HTML::getHTML('original="','" width',$arrA[2][$key]);
	if(!empty($img2[1])){
		$img = $img2[1];
		continue;
	}
	$img2 = HTML::getIMG($arrA[2][$key]);
	if(!empty($img2[2][0])){
		$img = $img2[2][0];
		continue;
	}
	...
	$content = getUrlContent($url2);
	$swfInfo = HTML::getHTML('var downurl=\'','\';
var url',$content);
	$swf = urldecode( $swfInfo[1] );
	$mp3Info = HTML::getHTML('收藏<\/a>','Toolxiaobanlong',$content);
	$mp3Info = HTML::getA($mp3Info[0]);
	$url3 = $mp3Info[1][0];
	if($url3 == ''){
		$mp3Info = HTML::getHTML('收藏','有问题，反馈一下',$content);
		$mp3Info = HTML::getA($mp3Info[0]);
		$url3 = $mp3Info[1][0];
		//var_dump($mp3Info);exit;
	}
	if($url3 == ''){
		echo "url3 empty";
		continue;
	...
	if($url3 != 'javascript:'){
	$url3 = str_replace("mp3-","mp3-d",$url3);
	$content = getUrlContent($url3);
	$mp3Info = HTML::getHTML('【播放次数】','次<br>
                    【下载次数】',$content);
	$num = $mp3Info[1];
	$mp3Info = HTML::getHTML('本地下载','右键点击链接',$content);
	$mp3Info = HTML::getA($mp3Info[1]);
	$mp3 = $mp3Info[1][0];
	}else{
		$mp3 = '';
	}
	$tempArr[$title] = array('title'=>$title,'cate'=>$cate,'num'=>$num,'img'=>$img,'txt'=>$txt,'mp3'=>$mp3,'swf'=>$swf,'url'=>$url2);
...
function saveArr($data){
	$tempArr = file(DATA_NEWID.'youban.txt');
	if(!empty($tempArr)){
	...
	$same = $add = 0;
	foreach($data as $val){
		if(!empty($titleArr) && in_array($val['title'],$titleArr)){
			$same++;
			$arrSame[] = $val;
			continue;
		}
	...
	$tempStr = file_get_contents(DATA_NEWID.'youban.txt');
	foreach($arrSame as $val){
		$one = "title=>{$val['title']}`cate=>";
		$two = "title=>{$val['title']}`cate=>{$val['cate']}";
		if(strpos($tempStr,$two)!==false){
			continue;
		}
		$two = "title=>{$val['title']}`cate=>{$val['cate']}|";
		$tempStr = str_replace($one,$two,$tempStr);
	}
	file_put_contents(DATA_NEWID."youban.txt",$tempStr);
}
