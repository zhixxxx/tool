...
define("DATA_NEWID_FILE",'youban_20.txt');//youban_12.txt
$cate = '启蒙国学|三字经';//'成语故事';//'睡前故事';//'格林童话';//'安徒生童话';//'幼儿故事';//'动画故事';//'神话故事';//'名人故事';//'寓言故事';//'成语故事';//test; 
$arrUrl[] = 'http://www.youban.com/mp3-t3198.html';
//$arrUrl[] = 'http://www.youban.com/mp3-t3182.html';
...
foreach($arrA[1] as $key=>$val){
	...
	$mp3Info = HTML::getHTML('<div class="DownLoadGequInfoLeft">
            	<h2>','<\/h2>
                <p>
                    【资源类型】',$content);
	$title = $mp3Info[1];
...
function getListWWW($url){
    ...
    $arrA = HTML::getHTML('mp3GequlistBody','ToolBtm',$content);
